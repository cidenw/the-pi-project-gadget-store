<?php
	class Email extends CI_Controller{
		...
		function send_receipt(){
			...
			$mail->setFrom('thepiprojectph@gmail.com', 'Mailer');
			$mail->addAddress('joe@example.net', 'Joe User');     // Add a recipient
			$mail->addAddress('waleed.occidental@gmail.com');               // Name is optional
			$mail->addReplyTo('thepiprojectph@gmail.com', 'Information');
