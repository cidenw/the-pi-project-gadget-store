	...
	<table class = "table table-bordered">
		<tbody>
			<form action="<?=base_url().'account/register'?>" method="post" enctype="multipart/form-data">
				...
				<tr>
					<td> Password </td>
					<td> <input type="password" name="password" class = "form-control flat" required /> </td>
				</tr>
				<tr>
				...
				<td colspan = "2" align="center"><button type = "submit" name = "insert" class = "btn btn-inverse">Register</button></td>
